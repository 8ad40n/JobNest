        ...
        <main className="flex min-h-screen flex-col justify-between p-8 sm:p-24 container mx-auto px-1 lg:px-20 md:px-10">
            <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="flex justify-between mb-4">
                    ...
                    <button className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition-colors duration-300">Add Blog</button>
                </div>
                {blogs.map((blog, index) => (
                    <div key={index} className="bg-gray-100 p-4 rounded-lg mb-4">
                        ...
                        <h3 className="text-xl font-semibold mt-2">Title: {blog.title}</h3>
